...
fun main() {
    val funcionario1 = Funcionario("Marcos AND Lima", 25)
    println("Novo funcionário registrado: ${funcionario1.nome}")

    val gerente1 = Gerente("Gustavo Wagner", 40, "Desenvolvedor Senior")
    val desenvolvedor1 = Desenvolvedor("Marcos AND Lima", 25, "Kotlin")
    val analista1 = Analista("Heremite", 35, "Product Owner Senior")

    val listaFuncionarios = listOf(funcionario1, gerente1, desenvolvedor1, analista1)
